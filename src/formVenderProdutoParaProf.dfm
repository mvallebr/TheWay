inherited frmVenderProdutoParaProf: TfrmVenderProdutoParaProf
  Left = 138
  Top = 75
  Width = 798
  Caption = 'Efetuar venda de produto para profissional'
  OldCreateOrder = True
  ...
  object Label2: TLabel
    ...
    Width = 469
    Height = 36
    Caption = 'Vender produto para profissional'
